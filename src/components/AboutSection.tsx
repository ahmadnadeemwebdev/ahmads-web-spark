        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="space-y-6">
            <p className="text-muted-foreground text-lg leading-relaxed">
              I'm Ahmad Nadeem — a video editor and motion designer based in Lahore, Pakistan. 
              I specialize in creating scroll-stopping content for social media, cinematic brand 
              videos, and dynamic motion graphics.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              With 2+ years of hands-on experience, I've worked with creators and brands 
