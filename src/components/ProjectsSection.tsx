...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "A simple yet powerful to-do app to organize daily tasks. Helps users stay productive by managing tasks with add, edit, delete, and completion features.",
